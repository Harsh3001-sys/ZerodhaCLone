    ...
    <>
      <div className='uni-images'>
        <div className='row evenly uni-cont'>
          <div>
            <a href="/"><img src='../logo.png' alt="" className='uni-img kite' /><br></br>
              <span className='uni-span'>Fast and elegant trading platform for stocks,
                 derivatives, commodities, and more.
              </span></a>
          </div>
          <div>
            <a href="/"><img src='/images/console.png' alt="" className='uni-img' /><br></br>
        ...
        <div className='row evenly uni-cont'>
          <div>
            <a href="/"><img src='/images/coin.png' alt="" className='uni-img' /><br></br>
