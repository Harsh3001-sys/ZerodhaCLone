  ...
  try {
    ...
    const response = await axios.get(
      "https://apidojo-yahoo-finance-v1.p.rapidapi.com/market/v2/get-quotes",
      {
        params: {
          symbols:
            "^NSEI,^BSESN,INFY.NS,TCS.NS,RELIANCE.NS,WIPRO.NS,ITC.NS,ONGC.NS,SBIN.NS,HDFCBANK.NS,ICICIBANK.NS,BHARTIARTL.NS,KPITTECH.NS,TATAMOTORS.NS,AXISBANK.NS,MARUTI.NS,BAJFINANCE.NS,LT.NS,ASIANPAINT.NS,HINDUNILVR.NS,SUNPHARMA.NS,ADANIENT.NS",
          region: "IN"
        },
        headers: {
