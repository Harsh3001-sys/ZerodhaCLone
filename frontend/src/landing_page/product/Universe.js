        ...
        <div className='container text-center'>
            ...
            <div className='uni-images'>
                <div className='row evenly uni-cont'>
                    <div>
                        <a href="/"><img src='/images/zerodhaFundhouse.png' alt=""  className='uni-img' /><br></br>
                    ...
                    <div>
                        <a href="/"><img src='/images/streakLogo.png' alt=""  className='uni-img streak' /><br></br>
                ...
                <div className='row evenly uni-cont'>
                    <div>
                        <a href="/"><img src='/images/sensibullLogo.svg' alt="" className='uni-img' /><br></br>
                    ...
                    <div>
                        <a href="/"><img src='/images/smallcaseLogo.png' alt="" className='uni-img' /><br></br>
                ...
                <div className='row evenly uni-cont'>
                    <div>
                        <a href="/"><img src='/images/tijori.svg' alt="" className='uni-img tijori' /><br></br>
                    ...
                    <div>
                        <a href="/"><img src='/images/dittoLogo.png' alt="" className='uni-img ditto' /><br></br>
